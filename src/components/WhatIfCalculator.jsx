// src/components/WhatIfCalculator.jsx
import { useState, useEffect } from 'react'
import { useNavigate } from 'react-router-dom'
import { supabase } from '../supabaseClient'

export default function WhatIfCalculator({ profile, locationId = 'holladay-3900s' }) {
  ...
  return (
    <div className="bg-white shadow rounded p-4 sm:p-6 mb-6">
      ...
      <p className="mt-4 text-sm leading-relaxed">
        Tip: pick a realistic number of upsells per day (e.g., 10). Then enter the add-on (e.g., $2.59
        for one turnover). That’s how you translate small wins into annual sales impact.
      </p>

      <p className="mt-2 text-sm italic">
        *Check out the speed page to see impact from increasing transactions with the current average
        check.
      </p>
